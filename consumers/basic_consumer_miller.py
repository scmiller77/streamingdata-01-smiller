...
def process_message(log_file) -> None:
    ...
    with open(log_file, "r") as file:
        ...
        while True:
            ...
            if "lit frfr" in message and "dead. It was so good I died and have ascended to the astral plane" in message:
                print(f"ALERT: We got the youth support! \n{message}")
                logger.warning(f"ALERT: We got the youth support! \n{message}")
