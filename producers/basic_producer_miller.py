...
ADJECTIVES: list = ["amazing", "incredible", "lit frfr", "atrocious", "mediocre at best", "overrated"]
NEG_ACTIONS: list = ["not mad, just disappointed", "contemplating calling the police", "disgusted"]
POS_ACTIONS: list = ["filled with joy", "going to tell everyone to check it out", "dead. It was so good I died and have ascended to the astral plane"]
TOPICS: list = ["service", "atmosphere", "drink menu", "food", "live music"]

# define positive and negative adjectives
POSITIVE: list = ["amazing", "incredible", "lit frfr"]
NEGATIVE: list = ["atrocious", "mediocre", "overrated"]
#####################################
...
def generate_messages():
    ...
    while True:
        ...
        if adjective in POSITIVE:
            action = random.choice(POS_ACTIONS)
        else:
            action = random.choice(NEG_ACTIONS)
        
        topic = random.choice(TOPICS)
        yield f"The {topic} was {adjective}! I am {action}."
