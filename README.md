...
py -m producers.basic_producer_miller
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m producers.basic_producer_miller
```
...
```shell
.venv\Scripts\activate
py -m consumers.basic_consumer_miller
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m consumers.basic_consumer_miller
```
